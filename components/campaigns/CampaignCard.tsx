...
export function CampaignCard({ campaign }: CampaignCardProps) {
  ...
  return (
    <motion.article
      ...
      className="card-elevate flex h-full flex-col overflow-hidden rounded-xl bg-[var(--g-color-base-float)]"
    >
      <Link
      ...
      >
        ...
        <div className="flex grow flex-col gap-3 p-4 md:p-6">
          ...
          <p className="text-sm opacity-70">by {campaign.creatorName}</p>
          ...
          <span className="text-sm font-medium text-[var(--g-color-text-info)]">
            View details →
          </span>
        </div>
      </Link>
